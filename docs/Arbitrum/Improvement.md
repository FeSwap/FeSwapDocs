---
id: improvement
title: FeSwap Improvements on Arbitrum
hide_title: true
sidebar_label: 'Improvement on Arbitrum'
---

<div  className="title">
  <h1> FeSwap Improvements on Arbitrum </h1>
</div>

_______________________

Some improvements have been made to the FeSwap protocol implementation deployed on Arbitrum Network, which mainly include following 4 features： 
...
+ A `Patch` mechanism is designed, and applied to a few FeSwap core smart contracts.
  ...
  + `Patch` mechanism is applied in 4 smart contract: `Factory`, `Router`, `NFT` and `FESW@A`. <br/><br/>
...
+ Some NFT bid settings are changed according to Arbitrum network characteristics, mainly include:
  ...
  + FESW@A giveaway rates are changed accordingly.<br/>
    *[** Learn more about NFT bidding on Arbitrum](./nft)*<br/>
