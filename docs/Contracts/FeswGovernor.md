...
title: FESW DAO
hide_title: true
sidebar_label: FeSwap Governor
hide_table_of_contents: true
---

<div  className="title">
  <h1> FeSwap Governor Contract </h1>
</div>
...
### <span className="title"> FeSwap Governor Contract Address </span>
...
FeSwap `FeswGovernor` code is open-sourced at [Github FeSwapCore Project](https://github.com/FeSwap/Governance/blob/main/contracts/FeswGovernor.sol) 

Following is the code deployed:

```sol title="FeswGovernor.sol"
